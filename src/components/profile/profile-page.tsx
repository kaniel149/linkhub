          ...
          {canvasVideo && (
            ...
            >
              <video
                ...
                className="w-full h-full object-cover"
                style={{ filter: 'brightness(0.5) saturate(1.4)', objectPosition: 'center 35%', willChange: 'auto' }}
              />
            </div>
          )}
          ...
          {!canvasVideo && (!canvasImages || canvasImages.length === 0) && bannerImage && (
            ...
            >
              <img
                ...
                aria-hidden="true"
                className="w-full h-full object-cover"
                style={{ filter: heroImage ? 'blur(20px) saturate(1.8) brightness(0.4)' : 'blur(50px) saturate(1.5) brightness(0.45)', objectPosition: 'center 35%' }}
              />
            </m.div>
          )}
